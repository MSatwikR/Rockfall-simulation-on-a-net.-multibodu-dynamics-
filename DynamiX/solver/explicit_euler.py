...
def explicit_euler(system, h, tf):
    """
    Performs numerical integration using the explicit Euler method for a dynamical system.
    ...
    # Print solver info
    print('Solver - Explicit Euler method:')
    print(' ')
    ...
    for k in tqdm(range(N)):
        ...
        # Update the position using the explicit Euler formula
        q[k + 1] = q[k] + h * v[k]
